...
namespace EXandIM.Web.Data.Migrations
{
    ...
    [Migration("20240603210719_add_SecondSubEntity_in_Books")]
    partial class add_SecondSubEntity_in_Books
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EXandIM.Web.Core.Models.Book", b =>
                {
                    ...
                    b.Property<int>("SecondSubEntityId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EXandIM.Web.Core.Models.Book", b =>
                {
                    ...
                    b.HasOne("EXandIM.Web.Core.Models.SecondSubEntity", "SecondSubEntity")
                        .WithMany()
                        .HasForeignKey("SecondSubEntityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("EXandIM.Web.Core.Models.SecondSubEntity", b =>
                {
                    ...
                    b.HasOne("EXandIM.Web.Core.Models.Entity", "SubEntity")
                        .WithMany()
                        .HasForeignKey("SubEntityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
